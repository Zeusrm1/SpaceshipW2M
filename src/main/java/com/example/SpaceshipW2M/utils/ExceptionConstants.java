...
public final class ExceptionConstants {
	...
	public static final String SPACESHIP_NAME_ALREADY_EXISTS = "Spaceship name already exists";
	public static final String SPACESHIP_NAME_NOT_FOUND = "Spaceship name not found";
